...
const born1500s = inventors.filter(inventor => inventor.year < 1600 && inventor.year > 1499)
...
const yearsLivedSum = inventors.reduce((total, inventor) => {
    return total + (inventor.passed - inventor.year)
}, 0)
console.log(yearsLivedSum)
...
const alphaOrder = people.sort((a, b) => {
...
const repetition = data.reduce((thing, repeats) => {
    if (!thing[repeats]) {
        thing[repeats] = 0
    }
    thing[repeats]++
